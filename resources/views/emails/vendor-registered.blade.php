                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div class="button-container" align="left"
                                                ...
                                                <p>Dear {{ $name }}</p>
                                                <p>Welcome to Altara! We're excited to have you as a merchant and look
                                                    forward to working with you.</p>
                                                <p>As a security measure, we ask that you change your password upon
                                                    first login. Please follow this link to do so: {{ $url }}
                                                </p>
                                                <p>Please let us know if you have any issues or need assistance.</p>
                                            </div>
                                            <!--[if mso]>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
